...
func main() {
	...
	libraryApp := library.App{Repository: library.Repository{DB: db}, Auth: tokens, Storage: objectStorage, MediaBase: cfg.MediaPublicBaseURL}
	mux.Handle("/api/v1/library/", libraryApp.PathHandler())
